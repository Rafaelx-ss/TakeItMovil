...
<TouchableOpacity
    ...
    <View style={styles.progressContainer}>
        ...
        <View>
            ...
            <Text style = {styles.subtitulo}>Ingresa todos tus datos y todos hacemos la magia....</Text>
        </View>
        ...
        <View style={styles.Text}>  
         ...
         <TouchableOpacity style={styles.buttom} onPress={() => router.push('/login/ReguistreLike')}>
